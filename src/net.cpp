...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "shopfit " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    ...
    {"kwadnation.com", "node2.kwadnation.com"},
    {"kwadnation.com", "node3.kwadnation.com"},
    {"kwadnation.com", "node4.kwadnation.com"},
    {"kwadnation.com", "node5.kwadnation.com"},
    {"kwadnation.com", "node6.kwadnation.com"},
	{"shopfit.ro", "node1.shopfit.ro"},
    {"shopfit.ro", "node2.shopfit.ro"},
    {"shopfit.ro", "node3.shopfit.ro"},
    {"shopfit.ro", "node4.shopfit.ro"},
    {"shopfit.ro", "node5.shopfit.ro"},
	{"shopfit.ro", "node6.shopfit.ro"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("shopfit-dnsseed");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. shopfit is probably already running."), addrBind.ToString().c_str());
        else
