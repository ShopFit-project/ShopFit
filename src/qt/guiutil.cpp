...
{
    // Convert ShopFit:// to ShopFit:
    //
    //    Cannot handle this later, because bitcoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("ShopFit://"))
    {
        uri.replace(0, 12, "ShopFit:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "ShopFit.lnk";
}
...
{
    return GetAutostartDir() / "ShopFit.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("ShopFit-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  ShopFit-qt [" + tr("command-line options") + "]                     " + "\n";
...
{
    app.setStyleSheet("QTableView { color: rgb(255,255,255); alternate-background-color: rgb(37, 72, 92); background-color: rgb(37, 72, 92); gridline-color: rgb(90,104,118); }"
                      "QWidget        { background-color: rgb(37, 72, 92); color: rgb(255,255,255); }"
                      ...
                      "QPushButton    { background-color: rgb(37, 72, 92); color: rgb(255,255,255); }"
                      "QMenuBar       { background-color: rgb(37, 72, 92); color: rgb(255,255,255); }"
                      "QMenu          { background-color: rgb(37, 72, 92); color: rgb(255,255,255); }"
                      "QMenuBar::item {background-color: transparent;}"
                      "QMenu::item:selected { background-color: rgb(37, 72, 92); }"
                      "QTreeView::item { background-color: rgb(37, 72, 92); }"
                      "QTreeView::item:selected { background-color: rgb(37, 72, 92); }"
                      "QHeaderView::section { background-color: rgb(37, 72, 92); color: rgb(255,255,255); }"
                      "QToolBar       { background-color: rgb(37, 72, 92); border: none; }"
                      "QTextEdit      { background-color: rgb(37, 72, 92); color: rgb(255,255,255); }"
                      "QPlainTextEdit { background-color: rgb(178,178,178); color: rgb(255,255,255); }"
                      "QComboBox      { background-color: rgb(37, 72, 92); color: rgb(255,255,255); }"
                      "QComboBox QAbstractItemView::item { color: rgb(37, 72, 92); }"
