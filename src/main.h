...
public:
    ...
    {
        // ShopFit: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // ShopFit: get transaction coin age
...
public:
    ...
    // ShopFit: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // ShopFit: two types of block: proof-of-work or proof-of-stake
    ...
    // ShopFit: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // ShopFit: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // ShopFit: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // ShopFit: block index flags
    enum  
    {
